...
- [kross hugo](https://github.com/themefisher/kross-hugo) template.


## Licensing

- Open source website created for an organization for environment care.
- Licensed under MIT (https://github.com/maguri/zerowastecat/blob/master/LICENSE)
- Theme: Copyright 2019 Themefisher (https://themefisher.com/)
- Theme: Licensed under MIT (https://github.com/themefisher/kross-hugo/blob/master/LICENSE)


## Premium Kross-Hugo Themes
